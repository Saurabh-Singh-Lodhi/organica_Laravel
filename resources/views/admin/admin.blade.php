                                        ...
                                        <tbody>
                                            @foreach ($orders as $order)
                                                ...
                                                <tr>
                                                    ...
                                                    <td
                                                        class="{{ optional($order->orderproducts->first())->status === 'pending' ? 'text-yellow' : (optional($order->orderproducts->first())->status === 'cancelled' ? 'text-red' : (optional($order->orderproducts->first())->status === 'received' ? 'text-green' : '')) }}">
                            ...
                            <div class="card-body p-0">
                                <ul class="country-sales list-group list-group-flush">
                                    <li class="country-sales-content list-group-item"><span class="mr-2"><i
                                                class="flag-icon flag-icon-us" title="us" id="us"></i>
                                        </span>
