    ...
    <article>
      ...
      <section class="hero">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <p class="hero-subtitle">Buy Your Favorite Food.</p>

            <h2 class="h1 hero-title">
              Your Personal <span class="span"> Food</span>
               Factory & <span class="span">veges.</span>
            </h2>
        ...
        <div class="container">
          ...
          <ul class="service-list">
            ...
            <li class="service-item">
              ...
              <h3 class="h3 item-title">Shipping Offer</h3>
            </li>
            ...
            <li class="service-item">
              ...
              <h3 class="h3 item-title">Secure Transaction</h3>
            </li>
            ...
            <li class="service-item">
              ...
              <h3 class="h3 item-title">Customer care</h3>
            </li>
          ...
          <ul class="offers-list has-scrollbar">
            ...
            <li class="offers-item">
              <a href="{{route('shopnow')}}" class="offers-card">
                ...
                <div class="card-content">
                  <p class="card-subtitle">Up To 30% Off</p>
            ...
            <li class="offers-item">
              <a href="{{route('shopnow')}}" class="offers-card">
                ...
                <div class="card-content">
                  <p class="card-subtitle">Up To 40% Off</p>
      ...
      <section class="cta">
        <div class="container">
          ...
          <h2 class="h2 section-title">Up To 30% Off All Product.</h2><br>
